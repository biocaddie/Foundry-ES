 ...
 */
public class KeywordEnhancerResourceTest {
    ...
    public void testPost() throws Exception {
        ...
        Response response = target.path("cinergi/enhancers/keyword").request(MediaType.APPLICATION_XML).post(Entity.xml(isoXmlInput));
